...
// Semua ikon SVG outline yang digunakan di seluruh aplikasi.

const mkIcon = (d) => (props) => (
  <svg
...
// Render ikon berdasarkan nama string (digunakan untuk ikon dari database)
